...
8. Caso o usuário informe algum dado que não esteja cadastrado, como um piloto, equipe, pista ou corrida, o sistema exibirá uma mensagem informando o problema e retornará ao menu principal.# 1. Descrição do Sistema
